...
#define P1    156250    /* = ceil(MAXN/64) */
#define P2    5000000   /* = ceil(MAXN/2) */
#define P3    1582      /* = ceil(ceil(sqrt(MAXN))/2) */
...
int main()
{
    ...
    for (n = 0, i = 0; i <= MAXN; i++)
        if (isprime(i)) { n++; printf("%d, ", i); }
    printf("\nThe number of primes below 10^8 is %d.\n", n);
    return 0;
}
